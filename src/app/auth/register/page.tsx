      ...
      <section className="relative min-h-[220px] bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 flex flex-col items-center justify-center text-center py-12 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Join <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-orange-600">Life Wood</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-600 mb-2">
            Create your account and start your journey with Life Wood Indonesia.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-md mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-xl border border-amber-100 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-amber-600 to-orange-600 p-6 text-center">
              ...
              <p className="text-amber-100 text-sm">Create your account to get started</p>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-600">
                  ...
                  <Link href="/auth/login" className="text-amber-600 hover:text-amber-700 font-semibold transition-colors">
                    Sign in here
                  </Link>
                </p>
              </div>
